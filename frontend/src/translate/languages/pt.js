	...
	pt: {
		translations: {
			signup: {
				...
				validate: {
					name: {
						...
						min: "Por favor, informe um nome maior",
						max: "Por favor, informe um nome menor",
					},
					phone: {
						required: "Por favor, informe o número de telefone",
					},
					email: {
						required: "Por favor, informe um e-mail",
						email: "Por favor, informe um e-mail valido",
						test: "E-mail já esta em uso",
					},
					password: {
						required: "Por favor, informe uma senha",
						min: "Por favor, informe uma senha maior",
						max: "Por favor, informe uma senha menor",
						confirmPassword: "Confirmação de senha é obrigatória",
						oneOf: "A confirmação de senha não coincide",
					},
					planId: {
			...
			backendErrors: {
				...
				ERR_SESSION_TOKEN_INVALID: "Token inválido. Tentaremos atribuir um novo na próxima solicitação.",
				...
				ERR_NO_ERROR_FOUND: "Ocorreu um erro, mas ja estamos verificando.",
				...
				ERR_INSUFFICIENT_RESOURCES: "O navegador encontrou um problema de falta de recursos ao tentar carregar uma página.",
			},
		},
	},
};
